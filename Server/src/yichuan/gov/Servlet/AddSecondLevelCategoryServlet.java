...
public class AddSecondLevelCategoryServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AddSecondLevelCategoryServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    Connect.releaseConnection(connection);//added by dujintao 20131226
	    System.out.println("成功添加新二级类别到数据库中！");
		
		out.print("<br><b>成功添加新二级类别到数据库中！</b>");
